    ...
    public class InMemoryOperationData : IOperationData
    {
        ...
        public InMemoryOperationData()
        {
            ...
            operations = new List<Operation>()
            {
                ...
                new Service   {Id = 5, Date = DateTime.Now, Description="Alquiler", Money = 15000, TypeOperation = Operation.OperationType.Expense, Branch = Operation.StoreBranch.Buffet, IsService=true, IsPaid = false, DueDate = dt},
